...
class Worker(QObject):
    ...
    def __init__(self, mode: int, paths: Dict[str, str]):
        super().__init__()
        self.mode = mode
        self.paths = paths
    ...
    def run(self):
        try:
            ...
            if self.mode == 0:  # 文件夹互查模式
                ...
                task_data, err = api_client.start_one_to_many_check(base_file, other_files)
